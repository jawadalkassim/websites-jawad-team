        ...
        >
            ...
            >
                <form
                        ...
                        id="regForm"
                        action="/Restoration/dist/thankYou-page.php"
                >
                    ...
                    <div class="tab text-white text-3xl font-bodyFont">
                        ...
                        <div class="pt-10 flex justify-center">
                            <input type="text" id="address" class="text-xl bg-blue-950 bg-opacity-60 placeholder-white text-white rounded-[7px] block lg:w-8/12 md:w-7/12 sm:w-full p-3.5" placeholder="Address" required />
                        </div>
