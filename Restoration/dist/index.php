...
<head>
    ...
    <link rel="icon" type="image/svg" href="/Restoration/dist/img/logo.svg">
    <link href="/Restoration/dist/output.css" rel="stylesheet" />
    <style>
        .duration-btn {
            transition: 0.2s;
        }
...
<nav class="text-center" style="background: white">
    ...
    >
        <div class="flex justify-center items-center p-2">
            <img src="/Restoration/dist/img/logo.svg" class="w-12 brand" />
        </div>
        <a
                href=""
...
<div class="w-full shadow list-bar bg-secondaryColor">
    ...
    >
        ...
        >
          ...
          ><img src="/Restoration/dist/img/chat.png" style="display: inline"
          /></span>
        ...
        >
          <span class="pr-2 icon w-8 flex justify-center items-center"
          ><img src="/Restoration/dist/img/location.png" style="display: inline" />
          </span>
            <h1 class="flex justify-center items-center">
        ...
        >
          <span class="pr-2 icon w-8 flex justify-center items-center"
          ><img src="/Restoration/dist/img/check.png" style="display: inline"
          /></span>
            <h1 class="flex justify-center items-center">
            ...
            >
                ...
                >
                    ...
                    <div data-tab class="tab text-white text-3xl font-bodyFont">
                        ...
                        />
                        <div class="text- text-3xl font-semibold pt-5 text-center p-5">
                            <h1 class="pb-3 text-4xl text-gray-600">Do you own or rent this property?</h1>
                        </div>
                        <label class="flex justify-center items-center pt-8">
                            <button data-btn type="button" onclick="radioClick(1)" class="duration-btn bg s text-xl gap-2 font-medium text-white bg-secondaryColor hover:bg-opacity-90 rounded-[7px] p-4 lg:w-9/12 md:w-7/12 sm:w-full py-3 mb-2 text-center items-center">
                                I own
                    ...
                    <div class="tab text-white text-3xl font-bodyFont">
                        ...
                        <div class="pt-10 flex justify-center">
                            <input type="text" name="address" id="address" class="text-xl bg-blue-950 bg-opacity-60 placeholder-white text-white rounded-[7px] block lg:w-8/12 md:w-7/12 sm:w-full p-3.5" placeholder="Address" required />
                        </div>
                    ...
                    <div class="tab text-white text-3xl font-bodyFont">
                        ...
                        <div class="pt-10 flex justify-center">
                            <input type="number" name="zip" pattern="[0-9]*" id="zip" class="text-xl bg-blue-950 bg-opacity-60 placeholder-white text-white rounded-[7px] block lg:w-8/12 md:w-7/12 sm:w-full p-3.5" placeholder="e.g. 12345" required />
                        </div>
                    ...
                    <div class="tab tab tab text-white text-3xl">
                        ...
                        <div class="flex justify-center pt-5 items-center">
                            <button type="button" onclick="nextPrev(1)" class="duration-btn bg s text-xl mt-3 gap-2 font-medium text-white bg-secondaryColor hover:bg-opacity-90 rounded-[7px] p-4 lg:w-1/3 md:w-7/12 sm:w-full py-3 mb-2 text-center items-center">
                                Next
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="tab text-white text-4xl font-bodyFont">
                        ...
                        <div class="pt-10 flex justify-center ">
                            <input type="text" name="fullName" id="name" class="text-xl placeholder-white bg-blue-950 bg-opacity-60 text-white rounded-[7px] block lg:w-8/12 md:w-7/12 sm:w-full p-3.5" placeholder="Enter first Name" required />
                        </div>
...
></script>
<script src="/Restoration/dist/script.js"></script>
</body>
</html>