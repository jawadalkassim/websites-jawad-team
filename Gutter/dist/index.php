             ...
             <div class="tab text-3xl">
                 ...
                 <div class="grid lg:grid-cols-3 md:grid-cols-1 sm:grid-cols-1 flex mx-0 justify-evenly mt-2">
                     <label class="card-radio-btn flex justify-center">
                         <input id="installation"  onclick="radioClick(0)" type="radio" class="card-input-element hidden">
                         <div class="card card-body mx-0">
                             <div class="content_head flex justify-center"><img src="/Gutter/dist/img/installation2.png" class="w-6/12 ins_img" ></div>
                             <div class="content_sub font-bold text-2xl pt-5" style="color: #444 !important;font-size: 1.5rem">Gutter Installation</div>
                         </div>
                     </label>
                     <label class="card-radio-btn flex justify-center">
                         <input onclick="radioClick(1)" type="radio" class="card-input-element hidden">
                         <div class="card card-body mx-0">
                             <div class="content_head flex justify-center"><img src="/Gutter/dist/img/repair2.png" class="w-6/12 ins_img"></div>
                             <div id="repair" class="content_sub font-bold text-2xl pt-5" style="color: #444 !important;font-size: 1.5rem">Gutter Repair</div>
                         </div>
                     </label>
                     <label class="card-radio-btn flex justify-center">
