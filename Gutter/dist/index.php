...
<div class="w-full shadow list-bar" style="background: #379c3bcc">
    ...
    >
        ...
        >
          ...
          ><img src="/Gutter/dist/img/chat.png" style="display: inline"
          /></span>
        ...
        >
          <span class="pr-2 icon w-8 flex justify-center items-center"
          ><img src="/Gutter/dist/img/location.png" style="display: inline" />
          </span>
            <h1 class="flex justify-center items-center">
        ...
        >
          <span class="pr-2 icon w-8 flex justify-center items-center"
          ><img src="/Gutter/dist/img/check.png" style="display: inline"
          /></span>
            <h1 class="flex justify-center items-center">
        ...
        >
            ...
            >
                <form
                        ...
                        id="regForm"
                        action="/Gutter/dist/submit-page.php"
                >
                ...
                <div class="tab text-white text-3xl font-bodyFont">
                    ...
                    <div class="pt-10 flex justify-center">
                        <input type="text" id="address" class="text-xl placeholder-white bg-blue-950 bg-opacity-60 text-white rounded-[7px] block lg:w-8/12 md:w-7/12 sm:w-full p-3.5" placeholder="e.g. 123 West Main Road" required />
                    </div>
