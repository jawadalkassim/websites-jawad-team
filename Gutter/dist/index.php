...
<body>
<nav class="text-center " style="background: #065c8b">
    <div class="grid lg:grid-cols-2 md:grid-cols-1 items-center ">
        <div class="flex justify-center items-center lg:w-5/12 md:w-6/12 pb-2">
            <img src="./img/logo.png" class="w-1/2">
        </div>
        <a href="" class="pt-2 text-white decoration-primaryColor font-bold text-xl block lg:text-end sm:text-center md:text-center lg:mx-40 md:mx-0 sm:mx-0 pb-3 lg:w-1/2 sm:w-full">Get Free Quotes</a>
    </div>
</nav>
<div class=" w-full grid grid-cols-3 p-3 justify-center bg-secondaryColor">
...
<div style="background-image: radial-gradient(ellipse at center,#1e5799 0,#013652 63%,#002031 100%)">
    <div class="grid lg:grid-cols-3 md:grid-cols-1 sm:grid-cols-1 justify-center items-center">
     <div class="pt-10 pb-10  pt-5 flex justify-center lg:col-span-2 sm:col-span-1">
         <form class="bg-white lg:p-10 md:p-0 sm:p-0 w-10/12 rounded " id="regForm" action="/dist/submit-page.php">
             <div class="tab text-3xl">
                 <div class="text- text-3xl font-semibold pt-16 text-center p-5">
                     <h1 class="pb-3 text-2xl text-gray-600">What is the aim of your
                         guttering project?</h1>
                 </div>
                 <div class="grid lg:grid-cols-3 md:grid-cols-1 sm:grid-cols-1 flex mx-0 justify-evenly mt-2">
                     <label class="card-radio-btn flex justify-center">
                         ...
                         <div class="card card-body mx-0">
                             ...
                             <div id="grand" class="content_sub font-bold text-2xl" style="color: #444 !important;">Gutter Installation</div>
                         </div>
                     </label>
                     <label class="card-radio-btn flex justify-center">
                         ...
                         <div class="card card-body mx-0">
                             ...
                             <div id="repair" class="content_sub font-bold text-2xl" style="color: #444 !important;">Gutter Repair</div>
                         </div>
                     </label>
                     <label class="card-radio-btn flex justify-center">
                         <input onclick="radioClick(2)" type="radio" class="card-input-element hidden">
                         <div class="card card-body mx-0">
                             <div class="content_head flex justify-center"><img src="./img/guard.png"></div>
                             <div id="installation" class="content_sub font-bold text-2xl" style="color: #444 !important;">Gutter Guard</div>
                         </div>
                     </label>
                 </div>
             </div>
    ...
    <div class="lg:text-start sm:text-center p-3">
        ...
        <div class="pt-10 ">
            ...
            <h3 class="text-xl text-white font-bold pt-3">
                by quickly comparing 3 FREE quotes
            </h3>
           <ul class="mt-8 text-white font-semibold" style="list-style: circle;list-style-position: inside">
            ...
            <div class="mt-5 lg:w-10/12 sm:w-full flex justify-center " style="padding: 25px;background: #005a87;">
                <div>
