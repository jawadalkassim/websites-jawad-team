...
<html lang="en">
  <head>
    ...
    ></script>
    <title>Gutter</title>
    <link rel="icon" type="image/x-icon" href="/Gutter/dist/img/favicon.ico" />
            ...
            >
              ...
              <div data-tab class="tab text-white text-3xl font-bodyFont">
                <input
                  data-store
                  type="text"
                  name="gutters-to-install"
                  class="hidden"
                />

                <div class="text- text-3xl font-semibold pt-5 text-center p-5">
                  <h1 class="pb-3 text-4xl text-gray-600">
                    What gutters do you want to install?
                  </h1>
                </div>
                <label class="flex justify-center items-center pt-8">
                  <button
              ...
              <div data-tab class="tab text-white text-3xl font-bodyFont">
                <input
                  data-store
                  type="text"
                  name="gutters-to-repair"
                  class="hidden"
                />
                <div class="text- text-3xl font-semibold pt-5 text-center p-5">
                  <h1 class="pb-3 text-4xl text-gray-600">
                    What gutters do you want to repair?
                  </h1>
                </div>
                <label class="flex justify-center items-center pt-8">
                  <button
