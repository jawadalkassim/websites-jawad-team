...
<head>
    ...
    <title>Remodeling Contractors</title>
...
<nav class="text-center " style="background: white">
    <div class="grid lg:grid-cols-2 md:grid-cols-1 items-center ">
        <div class="flex justify-center items-center p-2 ">
            <img src="/Remodeling/dist/img/logo.png" class="w-16 brand">
        </div>
...
<div class=" w-full grid grid-cols-3 p-3 justify-center shadow list-bar" style="background: #065c8b">
    <div class="text-center text-white font-bold flex justify-center items-center"><span class="pr-2 icon w-8 flex justify-center items-center"><img src="./img/chat.png" style="display: inline"></span><h1 class="flex justify-center items-center">Get the best quotes, fast!</h1></div>
    <div class="text-center text-white font-bold flex justify-center items-center"><span class="pr-2 icon w-8 flex justify-center items-center"><img src="./img/location.png" style="display: inline"> </span><h1 class="flex justify-center items-center">Over 5,000 engineers across the UK</h1></div>
    <div class="text-center text-white font-bold flex justify-center items-center"><span class="pr-2 icon w-8 flex justify-center items-center"><img src="./img/check.png" style="display: inline"></span><h1 class="flex justify-center items-center">Gas Safe registered engineers</h1></div>
</div>
<div>
<div class=" w-full grid grid-cols-3 p-3 justify-center shadow list-bar-mobile" style="background: #065c8b">
    <div class="text-center text-white font-bold flex justify-center items-center gap-2"><span class=" icon w-8 flex justify-center items-center"><img src="./img/chat.png" style="display: inline"></span><h1 class="flex justify-start items-center">Get the best quotes, fast!</h1></div>
    <div class="text-center text-white font-bold flex justify-center items-center gap-2 "><span class=" icon w-8 flex justify-center items-center"><img src="./img/location.png" style="display: inline"> </span><h1 class="flex justify-start items-center" >Over 5,000 engineers across the US</h1></div>
    <div class="text-center text-white font-bold flex justify-center items-center gap-2" style="padding-bottom: 0px"><span class=" icon w-8 flex justify-center items-center"><img src="./img/check.png" style="display: inline"></span><h1 class="flex justify-start items-center">Gas Safe registered engineers</h1></div>
</div>
            ...
            <form class="bg-white lg:p-10 md:p-0 sm:p-0 lg:w-10/12 rounded shadow-2xl pt-5" id="regForm" action="/Remodeling/dist/submit-page.php">
                ...
                <div class="tab text-white text-3xl font-bodyFont">
                    ...
                    <div class="grid lg:grid-cols-2">
                        <label class="flex justify-center items-center pt-8">
                            <input onclick="radioClick(3)" type="radio" class="card-input-element hidden">
                            <button type="button" onclick="radioClick(1)" class="bg s text-xl gap-2 font-medium text-white bg-secondaryColor hover:bg-opacity-90  rounded-full p-4  lg:w-full md:w-full sm:w-full py-3 me-2 mb-2  text-center items-center">
                                Garage Build
                            </button>
                        </label>
                        <label class="flex justify-center items-center pt-8">
                ...
                <div class="tab text-white text-3xl font-bodyFont">
                    ...
                    <div class="flex justify-center pt-5 items-center text-center">
                        <button type="button" onclick="nextPrev(1)" style="margin-top: 20px;" class="  bg s text-xl gap-2 font-medium text-white bg-secondaryColor hover:bg-opacity-90  rounded-full p-4 lg:w-1/3 md:w-full sm:w-full py-3 mb-2 mt-3  text-center items-center">
                            Next
                        </button>
                    </div>
                </div>
                ...
                <div class="tab tab tab text-white text-3xl">
                    ...
                    <div class="flex justify-center pt-5 items-center">
                        <button type="button"  style="margin-top: 20px;"onclick="nextPrev(1)" class="  bg s text-xl mt-3 gap-2 font-medium text-white bg-secondaryColor hover:bg-opacity-90  rounded-full p-4 lg:w-1/3 md:w-full sm:w-full py-3 mb-2  text-center items-center">
                            Next
                        </button>
                    </div>
                </div>
                ...
                <div class="tab tab tab text-white text-3xl">
                    ...
                    <div class="flex justify-center pt-5 items-center">
                        <button type="button" style="margin-top: 20px;" onclick="nextPrev(1)" class=" mt-3 bg s text-xl gap-2 font-medium text-white bg-secondaryColor hover:bg-opacity-90  rounded-full p-4 lg:w-1/3 md:w-full sm:w-full py-3 mb-2  text-center items-center">
                            Submit
                        </button>
                    </div>
                </div>
