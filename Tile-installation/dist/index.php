...
<html lang="en">
  ...
  <body class="font-bodyFont">
      ...
      >
        ...
        >
          <span class="pr-2 icon w-8 flex justify-center items-center"
            ><img src="/Tile-installation/dist/img/chat.png" style="display: inline"
          /></span>
        ...
        >
          <span class="pr-2 icon w-8 flex justify-center items-center"
            ><img src="/Tile-installation/dist/img/location.png" style="display: inline" />
          </span>
          <h1 class="flex justify-center items-center">
        ...
        >
          <span class="pr-2 icon w-8 flex justify-center items-center"
            ><img src="/Tile-installation/dist/img/check.png" style="display: inline"
          /></span>
          <h1 class="flex justify-center items-center">
    ...
    >
      ...
      <h3
        class="min-[992px]:pt-[80px] text-center text-[55px] max-[360px]:text-[25px] max-[480px]:text-[24px] font-bold text-secondaryColor pt-3 px-3 max-[480px]:pt-4 w-full lg"
      >
