      ...
      <select id="amount" name="estimated_debt" class="selectstyle__box__select">
        ...
        <div class="tab">
            ...
            <div class="flex justify-center py-24 items-center ">
                ...
                <button type="button" style="border: 1px solid black;margin-right: 20px" class="select_button font-bodyFont border-border-black border lg:px-20 lg:pt-5 text-2xl text-secondary font-bold rounded-lg " onclick="nextPrev(1)">Yes</button>
                <button type="button" style="border: 1px solid black;padding: 20px 50px" class="select_button font-bodyFont border-border-black border lg:px-20 lg:pt-5 text-2xl text-secondary font-bold rounded-lg" onclick="nextPrev(1)">No</button>
            </div>
        </div>
        <div class="tab">
            <div class="flex justify-center pt-2">
