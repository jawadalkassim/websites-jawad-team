...
<head>
    ...
    <link rel="icon" type="image/svg" href="/Pest-control/dist/img/logo.svg">
...
<div class="w-full shadow list-bar bg-secondaryColor">
    ...
    >
        ...
        >
          ...
          ><img src="/Pest-control/dist/img/chat.png" style="display: inline"
          /></span>
        ...
        >
          <span class="pr-2 icon w-8 flex justify-center items-center"
          ><img src="/Pest-control/dist/img/location.png" style="display: inline" />
          </span>
            <h1 class="flex justify-center items-center">
        ...
        >
          <span class="pr-2 icon w-8 flex justify-center items-center"
          ><img src="/Pest-control/dist/img/check.png" style="display: inline"
          /></span>
            <h1 class="flex justify-center items-center">
                    ...
                    <div data-tab class="tab text-white text-3xl font-bodyFont">
                        ...
                        <div class="grid lg:grid-cols-2 lg:gap-2">
                            <label class="flex justify-center items-center pt-3">
                                <button type="button" data-btn onclick="radioClick(1)" class="duration-btn bg s text-sm gap-2 font-medium text-white bg-secondaryColor hover:bg-opacity-90 rounded-[7px] p-4 lg:w-full md:w-7/12 sm:w-full py-3 mb-2 text-center items-center">
                                    Ants
                                </button>
                            </label>
                            <label class="flex justify-center items-center pt-3">
                        ...
                        <label class="flex justify-center items-center pt-3">
                            <button type="button" data-btn onclick="radioClick(1)" class="duration-btn bg s text-sm gap-2 font-medium text-white bg-secondaryColor hover:bg-opacity-90 rounded-[7px] p-4 lg:w-1/2 md:w-7/12 sm:w-full py-3 mb-2 text-center items-center">
                                Termites
                            </button>
                        </label>
                        </div>
