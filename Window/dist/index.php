...
<nav class="text-center " style="background: white">
    <div class="grid lg:grid-cols-2 md:grid-cols-1 items-center ">
        <div class="flex justify-center items-center p-2 ">
            <img src="/Window/dist/img/logo.png" class="w-12 brand">
        </div>
        <a href="" class="nav-link pt-3 text-primaryColor decoration-primaryColor font-bold text-xl block text-center sm:text-center md:text-center lg:mx-40 md:mx-0 sm:mx-0 pb-3 lg:w-1/2 sm:w-full">Get Free Quotes</a>
    </div>
</nav>
    ...
    <div  class="grid lg:grid-cols-12 md:grid-cols-1  sm:grid-cols-1 justify-center items-center lg:pb-44">
        ...
        <div class="lg:pt-10 pt-10 pb-10  flex justify-center lg:col-span-7 sm:col-span-1 border lg:pl-20 lg:pr-5 f-form" style="border: none;">
            <form class="bg-white lg:p-10 md:p-0 sm:p-0 lg:w-10/12 rounded shadow-2xl pt-5" id="regForm" action="/Window/dist/submit-page.php">
                ...
                <div class="tab text-white text-3xl font-bodyFont">
                    <div class="text- text-3xl font-semibold pt-16 text-center p-5">
                        <h1 class="pb-3 text-4xl text-gray-600">What is your windows type?</h1>
                    </div>
