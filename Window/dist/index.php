      ...
      >
        ...
        >
          <span class="pr-2 icon w-8 flex justify-center items-center"
            ><img src="/Window/dist/img/chat.png" style="display: inline"
          /></span>
        ...
        >
          <span class="pr-2 icon w-8 flex justify-center items-center"
            ><img src="/Window/dist/img/location.png" style="display: inline" />
          </span>
          <h1 class="flex justify-center items-center">
        ...
        >
          <span class="pr-2 icon w-8 flex justify-center items-center"
            ><img src="/Window/dist/img/check.png" style="display: inline"
          /></span>
          <h1 class="flex justify-center items-center">
        ...
        >
          ...
          >
            <form
              ...
              id="regForm"
              action="/Window/dist/thankYou-page.php"
            >
              ...
              <div class="tab text-white text-3xl font-bodyFont">
                <div class="text- text-3xl font-semibold pt-5 text-center p-5">
                  <h1 class="pb-3 text-4xl text-gray-600">
                    How many new windows do you need?
                  </h1>
                </div>
                <label class="flex justify-center items-center pt-8">
                  <input type="radio" class="card-input-element hidden" />
              ...
              <div class="tab text-white text-3xl font-bodyFont">
                ...
                <label class="flex justify-center items-center pt-2 px-[10px]">
                  <input type="radio" class="card-input-element hidden" />
                  <button
                    type="button"
                    onclick="radioClick(1)"
              ...
              <div style="overflow: auto" class="flex justify-center">
                ...
                >
                  <button
                    class="text-xl font-bold rounded-[4px] text-white bg-transparent bg-backBtnBg w-full"
                    type="button"
                    id="prevBtn"
                    onclick="back()"
                  >
