...
<nav class="text-center " style="background: white">
    <div class="grid lg:grid-cols-2 md:grid-cols-1 items-center ">
        <div class="flex justify-center items-center p-2 ">
            <img src="/Appliances/dist/img/logo.png" class="w-1/4 brand">
        </div>
            ...
            <div class="lg:pt-10 pt-10 pb-10  flex justify-center lg:col-span-7 sm:col-span-1 border lg:pl-20 lg:pr-5 f-form" style="border: none;">
                ...
                <div style="overflow:auto" class="flex justify-center" >
                    <div style="float:right;">
                        <button class="text-xl text-gray-600" type="button" id="prevBtn" onclick="nextPrev(-1)">Back</button>
                    </div>
                </div>
            </form>
        </div>
...
<script src="/Appliances/dist/script.js"></script>
</body>
