<div class="pt-8 sm:pt-16 pb-8">
	...
	<div class="py-4 md:py-8 px-8 text-sm leading-4 ease-in-out duration-300 mx-auto max-w-sm">
		...
		<div class="relative w-full text-sm leading-4 py-2">
            ...
            <input type="text" name="address" id="gm-autocomplete" class="peer block w-full mt-0.5 px-4 py-4 border border-gray-400 rounded-md shadow-sm focus:border-blue-500 focus:z-10 w-full text-lg placeholder-shown:not-empty" placeholder="Street Address" value="<?php if ($_SESSION['address']) echo $_SESSION['address']; ?>" required>
        ...
        <div class="relative w-full text-sm leading-4 py-2">
            ...
            <input type="text" name="city" id="city" class="peer block w-full mt-0.5 px-4 py-4 border border-gray-400 rounded-md shadow-sm focus:border-blue-500 focus:z-10 w-full text-lg placeholder-shown:not-empty" placeholder="City" value="<?php if ($_SESSION['city']) echo $_SESSION['city']; ?>" required>
        ...
        <div class="relative w-full text-sm leading-4 py-2">
            ...
            <select name="state" id="state" class="peer block w-full mt-0.5 pl-4 pr-10 py-4 bg-white border border-gray-400 rounded-md shadow-sm focus:border-sky-400 focus:z-10 ring-0 outline-0 w-full text-lg" required>
        ...
        <div class="relative w-full text-sm leading-4 py-2">
            ...
            <input type="text" name="zip" id="zip" class="peer block w-full mt-0.5 px-4 py-4 border border-gray-400 rounded-md shadow-sm focus:border-blue-500 focus:z-10 w-full text-lg placeholder-shown:not-empty" placeholder="Zip Code" minlength="5" maxlength="5" value="<?php if ($_SESSION['zip']) echo $_SESSION['zip']; ?>" required>
