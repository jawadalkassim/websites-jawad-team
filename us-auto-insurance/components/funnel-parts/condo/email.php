<div class="pt-8 sm:pt-16 pb-8">
  ...
  <div
    class="pt-4 md:pt-8 px-8 text-sm leading-4 ease-in-out duration-300 mx-auto max-w-sm"
  >
    <div class="relative w-full py-2">
              
      <label for="email" class=" pl-0.5 text-sm font-medium text-gray-900 hidden"> Email </label>
  ...
  <div
    class="custom-error-container transition ease-in-out duration-300 text-sm text-center"
  ></div>
      ...
      <div class="ml-3 agent-chat">
        <div class="bg-gray-100 p-3 rounded-lg shadow-xs w-fit">
          <p class="text-sm sm:text-md text-gray-600">
            Don't worry, we respect your privacy and won't send you unwanted
            e-mail.
          </p>
        </div>
