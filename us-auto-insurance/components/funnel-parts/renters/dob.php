<div class="pt-8 sm:pt-16 pb-8">
					...
					<div class="py-4 sm:py-8 mx-auto max-w-2xl text-center">
						...
						<button type="button" class="dob-next-button flex items-center justify-center bg-custom-blue  py-4 px-4  rounded-md w-full text-white text-2xl md:text-3xl font-bold  border-b-4 border-b-custom-dark-blue" data-action="next-step">
							Continue
						...
						<button type="button" class="dob-next-button flex items-center justify-center bg-custom-blue  py-4 px-4  rounded-md w-full text-white text-2xl md:text-3xl font-bold  border-b-4 border-b-custom-dark-blue opacity-30" data-action="next-step" disabled>
							Continue
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 ml-2 md:w-8 md:h-8">
								<path fill-rule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25Zm4.28 10.28a.75.75 0 0 0 0-1.06l-3-3a.75.75 0 1 0-1.06 1.06l1.72 1.72H8.25a.75.75 0 0 0 0 1.5h5.69l-1.72 1.72a.75.75 0 1 0 1.06 1.06l3-3Z" clip-rule="evenodd" />
							</svg>
