<div class="pt-8 sm:pt-16 pb-8">
    ...
    <h2 class="text-gray-700 text-3xl sm:text-4xl leading-8 font-extrabold text-center transition ease-in-out duration-300">Find Affordable Car Insurance!</h2>
    <p class="mt-2 text-gray-700 text-md sm:text-lg leading-6 leading-6 font-normal text-center transition ease-in-out duration-300">Take 2 minutes to compare rates.</p>
        ...
        <div class="flex items-start w-full">
            ...
            <div class="ml-3 agent-chat">
                <div class="bg-gray-100 p-3 rounded-lg shadow-xs w-fit">
                    <p class="text-sm sm:text-md text-gray-600">Car insurance policies start from just $<span class="underline underline-offset-0">&emsp;</span>.<span class="underline underline-offset-0">&emsp;&emsp;</span> a week</p>
                </div>
