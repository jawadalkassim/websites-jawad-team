<div class="pt-8 sm:pt-16 pb-8">
	...
	<div class="py-4 md:py-8 px-8 text-sm leading-4 ease-in-out duration-300 mx-auto max-w-sm">
		...
		<div class="relative w-full py-2">
			...
			<label for="first_name" class="block pl-0.5 text-sm font-medium text-gray-900"> First Name </label>
		...
		<div class="relative w-full py-2">
			...
			<label for="last_name" class="block pl-0.5 text-sm font-medium text-gray-900"> Last Name </label>
