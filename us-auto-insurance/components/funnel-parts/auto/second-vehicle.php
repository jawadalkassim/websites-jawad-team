<div class="pt-8 sm:pt-16 pb-8">
    ...
    <h2 class="text-gray-700 text-3xl sm:text-4xl leading-8 font-extrabold text-center transition ease-in-out duration-300">Add Second Vehicle?</h2>
    ...
    <div class="py-8 px-0 mx-auto max-w-4xl text-center grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <input type="hidden" id="secondVehicle" name="secondVehicle" value="<?php if ($_SESSION['secondVehicle']) echo $_SESSION['secondVehicle']; ?>">
        ...
        <div class="flex items-start w-full">
            ...
            <div class="ml-3 agent-chat">
                <div class="bg-gray-100 p-3 rounded-lg shadow-xs w-fit">
                    <p class="text-sm sm:text-md text-gray-600">If you have as second vehicle, we can save you up to 25%.</p>
                </div>
