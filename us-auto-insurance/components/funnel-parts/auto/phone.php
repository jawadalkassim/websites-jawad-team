<div class="pt-8 sm:pt-16 pb-8">
	...
	<h2 class="text-gray-700 text-3xl sm:text-4xl leading-8 font-extrabold text-center transition ease-in-out duration-300"><span class="first-name-text">
		<?php echo $_SESSION['first_name'] ? 'Last Step, '.$_SESSION['first_name'] : 'Last Step' ?></span>.</h2>
	<p class="mt-3 text-gray-700 text-md sm:text-lg leading-6 font-normal text-center transition ease-in-out duration-300">Your rates are a click away!</p>
	<h4 class="m-4 text-gray-700 text-3xl sm:text-4xl leading-8 font-extrabold text-center transition ease-in-out duration-300">What is your phone number?</h4>
	
	<div class="pt-0 md:pt-2 text-sm leading-4 ease-in-out duration-300 mx-auto max-w-sm">
	...
	<div id="tcpa" class="mt-3 text-sm sm:text-md font-light leading-5 ease-in-out duration-300 mx-auto max-w-sm text-gray-500 relative">
		...
		<p class="pl-8">By checking this box and clicking "View Rates" below, I consent to receive text messages and calls via an automatic telephone dialing system and an artificial or prerecorded voice to the phone number I entered above from speedyinsurancequotes.com as well as from insurance related providers and partners, for related products or service offers even if I am on a national, state, or entity-specific Do-Not-Call list. I understand that consent is not required to receive a quotation or make a purchase. Message and data rates may apply. For more information, please review our <a class="iframe" href="/footer/tcpa.php"><span class="underline underline-offset-2 text-custom-blue">TCPA Disclosure</span></a>.</p>
		<div class="custom-error pl-8 text-rose-500 text-md text-left pt-1 transition ease-in-out duration-300 hidden">You must agree to continue.</div>
	</div>
		...
		<div class="flex items-start w-full">
			...
			<div class="ml-3 agent-chat">
				<div class="bg-gray-100 p-3 rounded-lg shadow-xs w-fit">
					<p class="text-sm sm:text-md text-gray-600">Join the hundreds of american families we have helped save money this month.</p>
				</div>
