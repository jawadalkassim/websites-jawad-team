<div class="pt-8 sm:pt-16 pb-8">
    ...
    <h2 class="text-gray-700 text-3xl sm:text-4xl leading-8 font-extrabold text-center transition ease-in-out duration-300">Select your second vehicle?</h2>
    ...
    <div class="py-4 md:py-8 px-8">
        ...
        <div class="text-sm leading-4 pb-2 mx-auto max-w-sm ease-in-out duration-300">
            ...
            <label for="vehicleYear2" class="block pl-0.5 text-sm font-medium text-gray-700"> Year </label>
            <select name="vehicleYear2" id="vehicleYear2" class="peer block w-full mt-0.5 pl-4 pr-10 py-3 bg-white border border-gray-400 rounded-md shadow-sm focus:border-sky-400 focus:z-10 ring-0 outline-0 w-full text-lg placeholder-shown:not-empty" required>
                ...
                <?php
                    ...
                    foreach($reverse_year_array as $key => $value){
                        ...
                        if($value == $_SESSION['vehicleYear2']){

                            echo '<option value="'.$value.'" selected>'.$value.'</option>';

                            foreach($data_array[$_SESSION['vehicleYear2']] as $key => $value){
                                    
                                $vehicle_make_array[] = $key;

                                if($key == $_SESSION['vehicleMake2']){

                                    foreach($data_array[$_SESSION['vehicleYear2']][$_SESSION['vehicleMake2']] as $key => $value){

                                        $vehicle_model_array[] = $key;

                                        if($key == $_SESSION['vehicleModel2']){

                                            foreach($data_array[$_SESSION['vehicleYear2']][$_SESSION['vehicleMake2']][$_SESSION['vehicleModel2']] as $key => $value){
        ...
        ?>
            ...
            <label for="vehicleMake2" class="block pl-0.5 text-sm font-medium text-gray-700"> Vehicle Make </label>
            <select name="vehicleMake2" id="vehicleMake2" class="peer block w-full mt-0.5 pl-4 pr-10 py-3 bg-white border border-gray-400 rounded-md shadow-sm focus:border-sky-400 focus:z-10 ring-0 outline-0 w-full text-lg placeholder-shown:not-empty" required>
                ...
                <?php
                    ...
                    foreach($vehicle_make_array as $key => $value){
                        ...
                        if($value == $_SESSION['vehicleMake2']){
        ...
        ?>
            ...
            <label for="vehicleModel2" class="block pl-0.5 text-sm font-medium text-gray-700"> Vehicle Model </label>
            <select name="vehicleModel2" id="vehicleModel2" class="peer block w-full mt-0.5 pl-4 pr-10 py-3 bg-white border border-gray-400 rounded-md shadow-sm focus:border-sky-400 focus:z-10 ring-0 outline-0 w-full text-lg placeholder-shown:not-empty" required>
                ...
                <?php
                    ...
                    foreach($vehicle_model_array as $key => $value){
                        ...
                        if($value == $_SESSION['vehicleModel2']){
        ...
        ?>
            ...
            <label for="vehicleTrim2" class="block pl-0.5 text-sm font-medium text-gray-700"> Vehicle Trim </label>
            <select name="vehicleTrim2" id="vehicleTrim2" class="peer block w-full mt-0.5 pl-4 pr-10 py-3 bg-white border border-gray-400 rounded-md shadow-sm focus:border-sky-400 focus:z-10 ring-0 outline-0 w-full text-lg placeholder-shown:not-empty" required>
                ...
                <?php
                    ...
                    foreach($vehicle_trim_array as $key => $value){
                        ...
                        if($value == $_SESSION['vehicleTrim2']){
        ...
        <div class="text-sm leading-4 py-2 mx-auto max-w-sm ease-in-out duration-300 mx-auto max-w-sm">
            <label for="vehicleMileage2" class="block pl-0.5 text-sm font-medium text-gray-700"> Mileage </label>
            <input type="tel" name="vehicleMileage2" id="vehicleMileage2" class="mt-0.5 block w-full p-2.5 border border-gray-400 rounded-md shadow-sm focus:border-custom-blue focus:z-10 w-full text-lg placeholder-shown:not-empty" placeholder="Mileage" onkeyup="reformatText(this)" value="<?php if ($_SESSION['vehicleMileage2']) echo $_SESSION['vehicleMileage2']; ?>" maxlength="7" required>
            <div class="custom-error text-rose-500 text-xs text-left pt-1 transition ease-in-out duration-300 hidden">This field is required.</div>
        </div>
        ...
        <div class="flex items-start w-full">
            ...
            <div class="ml-3 agent-chat">
                <div class="bg-gray-100 p-3 rounded-lg shadow-xs w-fit">
                    <p class="text-sm sm:text-md text-gray-600">Tell us about your sencond car.</p>
                </div>
