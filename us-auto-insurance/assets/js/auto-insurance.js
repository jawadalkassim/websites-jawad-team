  ...
  for (let i = 1; i < stepCount; i++) {
    $("#Step" + i + ' button[data-action="next-step"]').on(
      ...
      function () {
        ...
        var vehicleArray1 = ["vehicleYear1", "vehicleMake1", "vehicleModel1"];
        ...
        var vehicleArray2 = ["vehicleYear2", "vehicleMake2", "vehicleModel2"];
...
function rebindVehicleSteps() {
  ...
  for (let i = 1; i < stepCount; i++) {
    //console.log(i);
    $("#Step" + i + ' .rebind-container button[data-action="next-step"]').on(
      "click",
      function () {
        console.log(i + " : found");
        dataTarget = $(this).attr("data-target");
        ...
        if (key == vehicleYear1) {
          ...
          $.each(value, function (key, value) {
            if (key == vehicleMake1) {
              ...
              $(".vehicle-1-make-list").append(
                '<button type="button" class="flex items-center justify-center bg-custom-dark-blue  py-4 px-4  rounded-md w-full text-white text-xl md:text-2xl font-bold  border-b-4 border-b-custom-dark-blue" data-target="vehicleMake1" data-value="' +
                  key +
              ...
              $(".vehicle-1-make-list").append(
                '<button type="button" class="flex items-center justify-center bg-custom-blue  py-4 px-4  rounded-md w-full text-white text-xl md:text-2xl font-bold  border-b-4 border-b-custom-dark-blue" data-target="vehicleMake1" data-value="' +
                  key +
                  '" data-action="next-step">' +
                  key +
                  "</button>"
            ...
            if (key == vehicleMake1) {
              ...
              $.each(value["models"], function (key, value) {
                if (value == vehicleModel1) {
                  ...
                  $(".vehicle-1-model-list").append(
                    '<button type="button" class="flex items-center justify-center bg-custom-dark-blue text-white py-4 px-4 font-bold rounded-md w-full text-xl md:text-2xl   border-b-4 border-b-custom-dark-blue" data-target="vehicleModel1" data-value="' +
                      value +
                      '" data-action="next-step">' +
                      value +
                      "</button>"
                  ...
                  $(".vehicle-1-model-list").append(
                    '<button type="button" class="flex items-center justify-center bg-custom-blue text-white py-4 px-4 font-bold rounded-md w-full  text-xl md:text-2xl  border-b-4 border-b-custom-dark-blue" data-target="vehicleModel1" data-value="' +
                      value +
                      '" data-action="next-step">' +
                      value +
                      "</button>"
        ...
        if (key == vehicleYear2) {
          ...
          $.each(value, function (key, value) {
            if (key == vehicleMake2) {
              ...
              $(".vehicle-2-make-list").append(
                '<button type="button" class="flex items-center justify-center bg-custom-dark-blue  py-4 px-4  rounded-md w-full text-white text-xl md:text-2xl font-bold  border-b-4 border-b-custom-dark-blue" data-target="vehicleMake2" data-value="' +
                  key +
                  '" data-action="next-step">' +
                  key +
                  "</button>"
              ...
              $(".vehicle-2-make-list").append(
                '<button type="button" class="flex items-center justify-center bg-custom-blue py-4 px-4  rounded-md w-full text-white text-xl md:text-2xl font-bold  border-b-4 border-b-custom-dark-blue" data-target="vehicleMake2" data-value="' +
                  key +
                  '" data-action="next-step">' +
                  key +
                  "</button>"
            ...
            if (key == vehicleMake2) {
              ...
              $.each(value["models"], function (key, value) {
                ...
                if (value == vehicleModel2) {
                  ...
                  $(".vehicle-2-model-list").append(
                    '<button type="button" class="flex items-center justify-center bg-custom-dark-blue  py-4 px-4  rounded-md w-full text-white text-xl md:text-2xl font-bold  border-b-4 border-b-custom-dark-blue" data-target="vehicleModel2" data-value="' +
                      value +
                      '" data-action="next-step">' +
                      value +
                      "</button>"
                  ...
                  $(".vehicle-2-model-list").append(
                    '<button type="button" class="flex items-center justify-center bg-custom-blue  py-4 px-4   rounded-md w-full text-white text-xl md:text-2xl font-bold  border-b-4 border-b-custom-dark-blue" data-target="vehicleModel2" data-value="' +
                      value +
                      '" data-action="next-step">' +
                      value +
                      "</button>"
