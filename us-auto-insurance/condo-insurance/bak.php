...
basename(dirname($current_file_path)); $insurance_type = 'life';
include_once(__DIR__.'/../components/header.php');
include_once(__DIR__.'/../resources/condo-insurance/form-options.php'); ?>
      ...
      <div
       ...
       <div class="pt-8 sm:pt-16 pb-8">
            <h2
              class="text-gray-700 text-3xl sm:text-4xl leading-8 font-extrabold text-center transition ease-in-out duration-300"
            >
            What is Your Property Used For?
            </h2>
          ...
          >
            <?php
							...
							foreach ($property_use as $key =>$value) {//$unsecured_debt_options / $unsecured_debt_amounts

              if($_SESSION['property_use'] == $value['value']){
               echo '<button type="button" class="flex items-center justify-center bg-custom-blue text-white py-4 px-4 font-bold rounded-md w-full text-xl md:text-2xl border-b-4 border-b-custom-dark-blue" data-target="property_use" data-value="'.$value['value'].'" data-action="next-step"> '.$value['text'].'</button>'; } 
               else {
                 echo '<button type="button" class="flex items-center justify-center bg-custom-blue text-white py-4 px-4 font-bold rounded-md w-full text-xl md:text-2xl border-b-4 border-b-custom-dark-blue" data-target="property_use" data-value="'.$value['value'].'" data-action="next-step"> '.$value['text'].'</button>'; } } 
               ?>
            ...
            <input
              ...
              id="property_use"
              name="property_use"
              value="<?php if ($_SESSION['property_use']) echo $_SESSION['property_use']; ?>"
            />
          </div>
         ...
         >
          ...
          >
            <?php
							...
							foreach ($property_age as $key =>$value) {//$unsecured_debt_options / $unsecured_debt_amounts

              if($_SESSION['property_age'] == $value['value']){
               echo '<button type="button" class="flex items-center justify-center bg-custom-blue text-white py-4 px-4 font-bold rounded-md w-full text-xl md:text-2xl border-b-4 border-b-custom-dark-blue" data-target="property_age" data-value="'.$value['value'].'" data-action="next-step"> '.$value['text'].'</button>'; } 
               else {
                 echo '<button type="button" class="flex items-center justify-center bg-custom-blue text-white py-4 px-4 font-bold rounded-md w-full text-xl md:text-2xl border-b-4 border-b-custom-dark-blue" data-target="property_age" data-value="'.$value['value'].'" data-action="next-step"> '.$value['text'].'</button>'; } } 
               ?>
            ...
            <input
              ...
              id="property_age"
              name="property_age"
              value="<?php if ($_SESSION['property_age']) echo $_SESSION['property_age']; ?>"
            />
          </div>
        ...
        <div class="pt-8 sm:pt-16 pb-8">
          ...
          >
            <?php
							...
							foreach ($property_size as $key =>$value) {//$unsecured_debt_options / $unsecured_debt_amounts

              if($_SESSION['property_size'] == $value['value']){
               echo '<button type="button" class="flex items-center justify-center bg-custom-blue text-white py-4 px-4 font-bold rounded-md w-full text-xl md:text-2xl border-b-4 border-b-custom-dark-blue" data-target="property_size" data-value="'.$value['value'].'" data-action="next-step"> '.$value['text'].'</button>'; } 
               else {
                 echo '<button type="button" class="flex items-center justify-center bg-custom-blue text-white py-4 px-4 font-bold rounded-md w-full text-xl md:text-2xl border-b-4 border-b-custom-dark-blue" data-target="property_size" data-value="'.$value['value'].'" data-action="next-step"> '.$value['text'].'</button>'; } } 
               ?>
            ...
            <input
              ...
              id="property_size"
              name="property_size"
              value="<?php if ($_SESSION['property_size']) echo $_SESSION['property_size']; ?>"
            />
          </div>
        ...
        <div class="pt-8 sm:pt-16 pb-8">
          ...
          >
            <?php
							...
							foreach ($stories as $key =>$value) {//$unsecured_debt_options / $unsecured_debt_amounts

              if($_SESSION['stories'] == $value['value']){
               echo '<button type="button" class="flex items-center justify-center bg-custom-blue text-white py-4 px-4 font-bold rounded-md w-full text-xl md:text-2xl border-b-4 border-b-custom-dark-blue" data-target="stories" data-value="'.$value['value'].'" data-action="next-step"> '.$value['text'].'</button>'; } 
               else {
                 echo '<button type="button" class="flex items-center justify-center bg-custom-blue text-white py-4 px-4 font-bold rounded-md w-full text-xl md:text-2xl border-b-4 border-b-custom-dark-blue" data-target="stories" data-value="'.$value['value'].'" data-action="next-step"> '.$value['text'].'</button>'; } } 
               ?>
            ...
            <input
              ...
              id="stories"
              name="stories"
              value="<?php if ($_SESSION['stories']) echo $_SESSION['stories']; ?>"
            />
          </div>
         ...
         >
          ...
          >
            <?php
							...
							foreach ($military_affiliation as $key =>$value) {//$unsecured_debt_options / $unsecured_debt_amounts

              if($_SESSION['military_affiliation'] == $value['value']){
               echo '<button type="button" class="flex items-center justify-center bg-custom-blue text-white py-4 px-4 font-bold rounded-md w-full text-xl md:text-2xl border-b-4 border-b-custom-dark-blue" data-target="military_affiliation" data-value="'.$value['value'].'" data-action="next-step"> '.$value['text'].'</button>'; } 
               else {
                 echo '<button type="button" class="flex items-center justify-center bg-custom-blue text-white py-4 px-4 font-bold rounded-md w-full text-xl md:text-2xl border-b-4 border-b-custom-dark-blue" data-target="military_affiliation" data-value="'.$value['value'].'" data-action="next-step"> '.$value['text'].'</button>'; } } 
               ?>
            ...
            <input
              ...
              value="<?php if ($_SESSION['military_affiliation']) echo $_SESSION['military_affiliation']; ?>"
            />
          </div>
