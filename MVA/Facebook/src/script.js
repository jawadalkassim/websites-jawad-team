...
//functions to take me to the spiner
...
function validateDate() {
  var day = parseInt(document.getElementById("dob-day").value, 10);
  var month = parseInt(document.getElementById("dob-month").value, 10);
