...
<nav class="text-center " style="background: white">
    <div class="grid lg:grid-cols-2 md:grid-cols-1 items-center ">
        <div class="flex justify-center items-center p-2 ">
            <img src="/Roofing/dist/img/logo.png" class="w-2/12 brand">
        </div>
...
<div style="background-image: radial-gradient(ellipse at center,#1e5799 0,#013652 63%,#002031 100%);padding-top: 40px">
    <div class="grid lg:grid-cols-12 md:grid-cols-1 sm:grid-cols-1 justify-center items-center lg:pb-40" id="row ">
     <div class="lg:pt-10   flex justify-center lg:col-span-7 sm:col-span-1 border lg:pl-20 lg:pr-5 " style="border: none;">
