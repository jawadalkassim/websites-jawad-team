...
<html lang="en">
  <head>
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
      ...
      ></script>
    <title>Painter</title>
      <link rel="icon" type="image/svg" href="/Painter/dist/img/logo.svg">
      ...
      >
        ...
        >
          <span class="pr-2 icon w-8 flex justify-center items-center"
            ><img src="/Painter/dist/img/chat.png" style="display: inline"
          /></span>
        ...
        >
          <span class="pr-2 icon w-8 flex justify-center items-center"
            ><img src="/Painter/dist/img/location.png" style="display: inline" />
          </span>
          <h1 class="flex justify-center items-center">
        ...
        >
          <span class="pr-2 icon w-8 flex justify-center items-center"
            ><img src="/Painter/dist/img/check.png" style="display: inline"
          /></span>
          <h1 class="flex justify-center items-center">
            ...
            >
                    ...
                    <div data-tab class="tab text-white text-3xl font-bodyFont">
                        <input
                                data-store
                                type="text"
                                name="exterior-painting-service-need"
                                class="hidden"
                        />
                        <div class="text- text-3xl font-semibold pt-5 text-center p-5">
                    ...
                    <div data-tab class="tab text-white text-3xl font-bodyFont">
                        <input
                                data-store
                                type="text"
                                name="interior-painting-service-need"
                                class="hidden"
                        />
                        <div class="text- text-3xl font-semibold pt-5 text-center p-5">
